...
namespace iOS
{
	public class ObservableTableViewControllerEventArgs<T> : EventArgs
	{
		public T SelectedItem { get; set; }

		public ObservableTableViewControllerEventArgs (T selectedItem)
		{
	...
	public abstract class ExtendedObservableTableViewController<T> : UITableViewController, INotifyPropertyChanged
	{
		/// <summary>
		...
		/// </summary>
		public ExtendedObservableTableViewController()
...
//		}
		...
		/// </summary>
		/// <param name="handle">The handle to be used with this controller
		public ExtendedObservableTableViewController(IntPtr handle)
			: base(handle)
		{
			Initialize();
		}
		...
		/// <summary>
		/// Forces the children to implement a config method that configures any required delegates.
		/// </summary>
		/// <param name="handle">The handle to be used with this controller
		public abstract void ConfigureDelegates ();
		...
		protected virtual UITableViewCell CreateCell(NSString reuseId, UITableView tableView, NSIndexPath indexPath)
		{
			...
			return CreateCellDelegate(reuseId, tableView, indexPath);
		}
		...
		protected virtual void OnRowSelected(object item, NSIndexPath indexPath)
		{
			...
			if (handler != null)
			{
				handler(this, new ObservableTableViewControllerEventArgs<T>(_selectedItem));
			}
		}
		...
		protected class ObservableTableSource<T2> : UITableViewSource
		{
			...
			private readonly ExtendedObservableTableViewController<T2> _controller;
			...
			public override UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
			{
				var cell = tableView.DequeueReusableCell(_reuseId) ??
					_controller.CreateCell(_reuseId, tableView, indexPath);
			...
			public override UIView GetViewForHeader(UITableView tableView, nint section)
			{
				...
				{
					return _controller.GetViewForHeaderDelegate(tableView, (int)section);
				}
			...
			public override nfloat GetHeightForHeader(UITableView tableView, nint section)
			{
				...
				{
					return _controller.GetHeightForHeaderDelegate(tableView, (int)section);
				}
			...
			public override UIView GetViewForFooter(UITableView tableView, nint section)
			{
				...
				{
					return _controller.GetViewForFooterDelegate(tableView, (int)section);
				}
			...
			public override nfloat GetHeightForFooter(UITableView tableView, nint section)
			{
				...
				{
					return _controller.GetHeightForFooterDelegate(tableView, (int)section);
				}
			...
			{
				if (_controller.GetHeightForRowDelegate != null)
				{
					return _controller.GetHeightForRowDelegate(tableView, indexPath);
				}
