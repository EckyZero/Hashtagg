...
{
    [Activity(Label = "IncentiveCompletedAttestationActivity")]
    public class IncentiveCompletedAttestationActivity : IncentiveAttestationBaseActivity
    {
        private IncentiveCompletedAttestationViewModel _viewModel;
        
        private Button _submitButton;
        
        private FloatLabeledEditText _fullName;
		private FloatLabeledEditText _phoneControl;
		...
		protected override bool ShowPhoneControl {
			get {
				return _viewModel.ShowPhoneTextField;
			}
		}
        ...
        {
            IncentiveCompletedAttestationParameters parameters =
                _navigationService.GetAndRemoveParameter<IncentiveCompletedAttestationParameters>(Intent);

            _viewModel = new IncentiveCompletedAttestationViewModel(
                parameters.SelectedProvider,
                parameters.SelectedIncentiveAction,
                parameters.SelectedDate,
                parameters.SelectedIncentiveActionProcedure,
				parameters.ShowPhoneControl
            );
			...
			_phoneControl = FindViewById<FloatLabeledEditText>(Resource.Id.IncentiveAttestationConfirmationPhone);

            _fullName.TextChanged += FullNameTextChanged;

            _phoneControl.TextChanged += PhoneControlTextChanged;
        ...
        private void PhoneControlTextChanged(object sender, EventArgs args)
        {
            _viewModel.Phone = _phoneControl.Text;
        }
