package md5f867e7b15bce16215aa4e8a8a0e01f93;
		...
		com.squareup.okhttp.Callback
{
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("ModernHttpClient.AwaitableOkHttp/OkTaskCallback, ModernHttpClient, Version=2.1.5.0, Culture=neutral, PublicKeyToken=null", AwaitableOkHttp_OkTaskCallback.class, __md_methods);
	}
	...
	public AwaitableOkHttp_OkTaskCallback () throws java.lang.Throwable
	{
		...
		if (getClass () == AwaitableOkHttp_OkTaskCallback.class)
			mono.android.TypeManager.Activate ("ModernHttpClient.AwaitableOkHttp/OkTaskCallback, ModernHttpClient, Version=2.1.5.0, Culture=neutral, PublicKeyToken=null", "", this, new java.lang.Object[] {  });
	}
