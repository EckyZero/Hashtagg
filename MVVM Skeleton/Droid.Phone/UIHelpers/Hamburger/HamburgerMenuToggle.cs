...
namespace Droid.Phone
{
	...
	public class HamburgerMenuToggle : ActionBarDrawerToggle
	{
		public HamburgerMenuToggle(Activity activity, DrawerLayout drawerLayout,  int drawerImageRes, int openDrawerContentDescRes, int closeDrawerContentDescRes)
