...
namespace iOS.Phone
{
	partial class SurveyFacilityPromptListController : UIViewController
	{
		private SurveyFacilityPromptListTableController _tableController;

		public SurveyFacilityPromptListViewModel ViewModel { get; private set; }

		public SurveyFacilityPromptListController (IntPtr handle) : base (handle)
		{
			ViewModel = new SurveyFacilityPromptListViewModel ();
		}
		...
		public override void ViewDidLoad ()
		{
			...
			_tableController = ChildViewControllers [0] as SurveyFacilityPromptListTableController;
