	...
	public class ViewController : UIViewController
	{
		...
		public override void LoadView ()
		{
			...
			if (isV7)
				...
				niceSegmentedCtrl.Frame = new CGRect (0, 0, 320, 44);
			...
			if (isV7) 
				browser = new UIWebView (new CGRect (0, 55, UIScreen.MainScreen.Bounds.Width, UIScreen.MainScreen.Bounds.Height - 64));
			else
				browser = new UIWebView (new CGRect (0, 45, UIScreen.MainScreen.Bounds.Width, UIScreen.MainScreen.Bounds.Height - 64));
