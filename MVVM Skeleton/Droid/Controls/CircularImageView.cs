...
namespace Droid.Controls
{
    public class CircularImageView : ImageView
    {
        ...
        public CircularImageView(Context context, IAttributeSet attrs)
            : base(context, attrs, Resource.Attribute.CircularImageViewStyle)//,Resource.
        {
            this._attrs = attrs;
            Init();
        }
        ...
        private void Init()
        {
            ...
            _hasBorder = attributes.GetBoolean(Resource.Styleable.CircularImageView_circular_image_border, false);
            ...
            if (_hasBorder)
            {
                ...
                SetBorderWidth(attributes.GetDimensionPixelOffset(Resource.Styleable.CircularImageView_circular_image_border_width, defaultBorderSize));
                SetBorderColor(attributes.GetColor(Resource.Styleable.CircularImageView_circular_image_border_color, Color.White));
            }
